...
<head>
  <?php if(is_success()): ?> 
   ...
   <meta http-equiv="Cache-Control" content="no-store, no-cache, must-revalidate"> <!-- tells browser not to cache -->
   <meta http-equiv="Cache-Control" content="post-check=0, pre-check=0"> <!-- tells browser not to cache -->
