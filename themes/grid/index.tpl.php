...
<div id='outer-wrap-header'>
 ...
 <!--       <a href='<?=base_url()?>'>
        ...
        <span id='site-title' style='padding-left:0'> 
...
<div id='outer-wrap-column'>
  <div id='inner-wrap-column'>
    <div id='column-first'><?=render_views('column-first')?></div>
    <div id='column-middle'><?=render_views('column-middle')?></div>
    <div id='column-last'><?=render_views('column-last')?></div>
  </div>
</div>
<?php endif; ?>
