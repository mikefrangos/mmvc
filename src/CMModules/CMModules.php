<?php
/**
* A model for managing Mmvc modules.
* 
* @package MmvcCore
*/
class CMModules extends CObject {
  ...
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isMmvcCore']   = in_array($rc->name, $this->mmvcCoreModules);
      $details['isMmvcCMF']    = in_array($rc->name, $this->mmvcCMFModules);
